    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      for (var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (terminalPriority > directive.priority) {
          break; // prevent further workers of directives
        }
...
function $HttpProvider() {
   ...
   * @description
   *
   * Configure $http service to combine workers of multiple http responses received at around
   ...
   * pre-workers of request or postprocessing of responses.
   *
 ...
 *   ml_data and avoiding unnecessary browser repaints, which would result in flickering UI.
  ...
  return function dynamicDateInputType(scope, element, attr, ctrl, $sniffer, $browser, $filter) {
    ...
    ctrl.$parsers.push(function(value) {
      ...
      if (regexp.test(value)) {
        ...
        // parser/formatter in the workers chain so that the model
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   * value sent directly for workers, finally to be applied to `$modelValue` and then the
